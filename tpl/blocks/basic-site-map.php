<div class="bz-basic-site-map">
    ...
    <map name="Map">
        ...
        <area href="/<?= $routesParams[5][$linkParam]?>" coords="283,48,436,90" shape="RECT">
        ...
        <area href="/<?= $routesParams[6][$linkParam]?>" coords="40,415,189,458" shape="RECT">
        <!-- приобретение и продажа б/у техникики - дрезины -->
        <area href="/<?= $routesParams[6][$linkParam]?>" coords="20,353,171,395" shape="RECT">
        <!-- приобретение и продажа б/у техникики - Котлованокопатели -->
        <!-- <area href="/<?= $routesParams[6]['items'][2][$linkParam]?>" coords="20,291,171,331" shape="RECT"> -->
        <!-- приобретение и продажа б/у техникики - Вибропогружатели -->
        <area href="/<?= $routesParams[6][$linkParam]?>" coords="39,228,190,266" shape="RECT">
    </map>
</div>
