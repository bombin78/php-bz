	...
	<div class="bz-description">
		...
		<section class="bz-description__section">
			...
			<div class="bz-description__row">
				...
				<h2 class="bz-description__title">1. Сменное оборудование ТТН-057.2 для бурения лидирующих скважин</h2>
				...
				<p class="bz-description__text">
					...
					от минус 25 <sup>о</sup>С до плюс 40 <sup>o</sup>С.
				</p>
		...
		<section class="bz-description__section">
			...
			<div class="bz-description__row">
				...
				<p class="bz-description__text">
					Пневмоударный рабочий орган предназначен для бурения скважин 381 мм в скальных грунтах I и II группы
					по СТН ЦЭ 141-99 под фундаменты ФБС опор контактной сети и анкеры АБС, фундаменты ФТП-351, ФСТП-351,
					ФТ-351, ФСТ-351 и анкеры АСТ-351, АТ-351.
				</p>

				<p class="bz-description__text">
					Вид климатического исполнения оборудования У категории размещения 1 ГОСТ 15150 для работы при
					температурах от минус 25 <sup>о</sup>С до плюс 40 <sup>о</sup>С.
				</p>
			...
			<div class="bz-description__row">
				...
				<div class="bz-img-wrap">
					<img
						class="bz-img"
						alt="вибропогружатель АВФ-1, схема"
						src="/images/pages/navesnoe-oborudovanie/TTN-073.2-1.jpg"
						width="980"
						height="151">
				</div>
			...
			<div class="bz-description__row">
				...
				<table class="bz-params">
					...
					<tbody class="bz-params__body">
						...
						<tr class="bz-params__body-row">
							<td class="bz-params__body-cell">
								Диаметр скважины, мм (по коронке)
							</td>
							<td class="bz-params__body-cell">381</td>
						</tr>
						...
						<tr class="bz-params__body-row">
							...
							<td class="bz-params__body-cell">4,5</td>
						</tr>
						...
						<tr class="bz-params__body-row">
							...
							<td class="bz-params__body-cell">30+/-2,5</td>
						</tr>

						<tr class="bz-params__body-row">
							<td class="bz-params__body-cell">
								Частота вращения при бурении, 1/мин
							</td>
							<td class="bz-params__body-cell">15+5</td>
						</tr>

						<tr class="bz-params__body-row">
							<td class="bz-params__body-cell">
								Расход воздуха, м/мин, не менее
							</td>
							<td class="bz-params__body-cell">25</td>
						</tr>

						<tr class="bz-params__body-row">
							<td class="bz-params__body-cell">
								Избыточное давление воздуха, МПа (кгс/см), не менее
							</td>
							<td class="bz-params__body-cell">1,0 (10)</td>
						</tr>

						<tr class="bz-params__body-row">
							<td class="bz-params__body-cell">
								Время бурения одной скважины глубиной 3 м от УГР
								в грунтах I группы по СТН ЦЭ 141-99, мин, не более
							</td>
							<td class="bz-params__body-cell">40</td>
						</tr>

						<tr class="bz-params__body-row">
							<td class="bz-params__body-cell">
								Масса вращателя и бура, установленных в зажимном
								устройстве вибропогружателя, кг, не более
							</td>
							<td class="bz-params__body-cell">2500</td>
						</tr>
					...
					<tfoot class="bz-params__foot">
						<tr class="bz-params__foot-row">
							<td class="bz-params__foot-cell" colspan="2">
								Оборудование устанавливается в зажим вибропогружателя или в специальный кронштейн вместо вибропогружателя.
								Компрессорное оборудование в комплект поставки не входит. Может поставляться по отдельному заказу.
							</td>
						</tr>
					</tfoot>
