	...
	<ul class="map-level-0">
		<li>
			...
			<ul class="map-level-1">
				...
				<li><a href="/recuperators/recuperator-tepla-zakaz/">Рекуператор тепла</a></li>

				<li><a href="/recuperators/recuperator-industry-5/">Рекуператоры нового поколения</a></li>

				<li><a href="/recuperators/news/">Новости</a></li>
		...
		<li><a href="/capital-remont/">Капитальный ремонт</a>
			<ul class="map-level-1">
				...
				<li><a href="/capital-remont/cotlovanokopately-base/">Котлованокопатели на любой базе</a>					<ul class="map-level-2">

				<li><a href="/capital-remont/cotlovanokopately-base/VK-base-DGKU/">ВК на базе дрезины ДГКУ</a></li>

				<li><a href="/capital-remont/cotlovanokopately-base/VK3-rail/">ВК-3 на базе ЖД платформы</a></li>

				<li><a href="/capital-remont/cotlovanokopately-base/MPT-VK-5/">МПТ-ВК-5 на базе мотовоза МПТ-6</a></li>

				<li><a href="/capital-remont/cotlovanokopately-base/ADM-1.5B/">АДМ-1.5 Б исп. 6.1 на базе дрезины АДМ-1.3</a></li>
		...
		<li><a href="/spare-parts/">Запчасти к машинам ВК и АВФ</a></li>
		...
		<li>
			...
			<ul class="map-level-1">
				...
				<li><a href="/manufacturing/kotlovanokopateli/">Котлованокопатели</a>					<ul class="map-level-2">

				<li><a href="/manufacturing/kotlovanokopateli/VK-3-rail/">ВК-3 на базе ЖД платформы</a></li>

				<li><a href="/manufacturing/kotlovanokopateli/MPT-VK-5/">МПТ-ВК-5 на базе мотовоза МПТ-6</a></li>

				<li><a href="/manufacturing/kotlovanokopateli/VK-4-rail/">ВК-4 на базе ЖД платформы</a></li>

				<li><a href="/manufacturing/kotlovanokopateli/ADM-1.5B/">АДМ-1.5 Б исп. 6.1 на базе дрезины АДМ-1.3</a></li>
		...
		<li>
			...
			<ul class="map-level-1">
				...
				<li><a href="/buying-used-eqipment/drezins/">Дрезины ДГКУ, АДМ, МПТ</a></li>
		...
		<li>
			...
			<ul class="map-level-1">
				...
				<li><a href="/material/avtomatrisa/">Виды автоматрис и их назначение</a></li>
				...
				<li><a href="/material/vibropogruzhatel/">Вибропогружатель</a>
					<ul class="map-level-2">
						...
						<li><a href="/material/vibropogruzhatel/tehn-haracter/">Технические характеристики</a></li>
