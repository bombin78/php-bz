...
'2.2. Температура на входе ,°C: '
.$_POST['f2_2'].'<br>'.

'2.3. Температура на выходе ,°C: '
.$_POST['f2_3'].'<br>'.

'2.4. Расход на входе: '
.$_POST['f2_4'].' '.$_POST['f2_4_1'].'<br>'.

'2.5. Давление на входе: '
.$_POST['f2_5'].' '.$_POST['f2_5_1'].'<br>'.

'2.6. Допустимое аэродинамическое сопротивление: '
.$_POST['f2_6'].' '.$_POST['f2_6_1'].'<br>'.

'2.7. Компонентный состав дымового газа: '
.$_POST['f2_7'].'<br>'.

'2.8. Количество механических примесей, г/м³: '
.$_POST['f2_8'].'<br>'.

'3. Нагреваемая среда<br>'.
'3.1. Нагреваемая среда: '
.$_POST['f3_1'].'<br>'.

'3.2. Температура на входе, °C: '
.$_POST['f3_2'].'<br>'.

'3.3. Температура на выходе, °C: '
.$_POST['f3_3'].'<br>'.

'3.4. Расход на входе: '
.$_POST['f3_4'].' '.$_POST['f3_4_1'].'<br>'.

'3.5. Давление на входе: '
.$_POST['f3_5'].' '.$_POST['f3_5_1'].'<br>'.

'3.6. Допустимое аэродинамическое сопротивление: '
.$_POST['f3_6'].' '.$_POST['f3_6_1'].'<br>'.
